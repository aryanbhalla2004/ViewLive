      ...
      <form onSubmit={props.onSubmit}>
        <div className="d-flex col-2">
          <div className="full-width">
            <TextInput name="fName" type="Name" pattern="[a-zA-Z]+" error={props.error?.for} note={props.error?.note} placeholder="First Name" required={true} label="First Name *"/>
          </div>
          <div className="full-width">
            <TextInput name="lName" type="Name" pattern="[a-zA-Z]+" error={props.error?.for} note={props.error?.note} placeholder="Last Name" required={true} label="Last Name *"/>
          </div>
        </div>
