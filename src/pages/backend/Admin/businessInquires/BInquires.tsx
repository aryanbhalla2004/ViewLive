...
export const BInquires = () => {
  ...
  const getData = async () => {
    try {
      ...
      console.log(data);
      setData(response.data.listBusinesses.items);
    ...
    <div className='bbView-container'>
      <div className='dash-header-page'>
        <div className='name-path-dash-page'>
          ...
          <p className='path-style'>Dashboard <i className="bi bi-chevron-right"></i> Business Inquires</p>
        </div>
